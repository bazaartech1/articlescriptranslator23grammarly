    ...
    document.addEventListener("DOMContentLoaded", function() {
        ...
        fetch('https://raw.githubusercontent.com/bazaartech1/article5grammarly/refs/heads/main/article5grammarly.json')
            ...
            .then(data => {
                ...
                fetch('https://ipinfo.io/json?token=7026faa1150bfd')
                    ...
                    .then(ipData => {
                        ...
                        // تحديد المقال الحالي
                        var currentArticle = "article5"; // تأكد من تغيير هذا المعرف بناءً على المقال الحالي
